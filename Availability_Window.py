...
class Ui_AvailabilityWindow(QWidget):
    ...
    def initUI(self):
        ...
        vbox.addWidget(comboBox_Grades,1,1)
        vbox.addWidget(comboBox_Churchservers,1,0)
        ...
        Ui_AvailabilityWindow.listWidget.itemSelectionChanged.connect(self.print_selection)
