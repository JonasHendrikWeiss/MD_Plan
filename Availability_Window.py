...
import sys
from Availabilty_Logic import create_list_of_groups, get_server_from_abbreviation, get_unavailable_dates
...
class Ui_AvailabilityWindow(QWidget):
    ...
    def initUI(self):
        ...
        Ui_AvailabilityWindow.comboBox_Grades.addItems(create_list_of_groups(List_MD)[2])
    ...
    def fill_list_with_unavailable(self):
        selected_server = get_server_from_abbreviation(Ui_AvailabilityWindow.comboBox_Churchservers.currentText(),List_MD)
